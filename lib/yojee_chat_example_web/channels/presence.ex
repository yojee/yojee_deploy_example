defmodule YojeeChatExampleWeb.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule YojeeChatExample.MyChannel do
        use YojeeChatExampleWeb, :channel
        alias YojeeChatExample.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :yojee_chat_example,
                        pubsub_server: YojeeChatExample.PubSub
end
